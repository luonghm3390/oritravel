...
function st_map_base_shortcodes()
{
    ...
    vc_map( array(
        "name" => __("ST About Us", ST_TEXTDOMAIN),
        "base" => "st_about_us",
        "content_element" => true,
        "icon" => "icon-st",
        "category"=>"Shinetheme",
    ...
    vc_map( array(
        ...
        "params" => array(
            array(
                ...
                "param_name" => "st_style",
                "value" => array(
                    __("Grid",ST_TEXTDOMAIN)=>"style1",
                    __("List",ST_TEXTDOMAIN)=>"style2",
                )
            ),
            array(
                "type" => "textfield",
            ...
            array(
                "type" => "dropdown",
                "holder" => "div",
                "heading" => __("Number post per row",ST_TEXTDOMAIN),
    ...
    vc_map( array(
        ...
        "params" => array(
            ...
            array(
                "type" => "dropdown",
                "holder" => "div",
                "heading" => __("Page Link To", ST_TEXTDOMAIN),
                "param_name" => "link_to",
                'value'=>array(
    ...
    vc_map( array(
        ...
        "params"   => array(
            ...
            array(
                ...
                "description" => "" ,
                'value'       => array(
                    __( 'All Post Type' , ST_TEXTDOMAIN ) => 'st_cars,st_tours,st_rental,st_activity' ,
    ...
    vc_map( array(
        ...
        "params" => array(
            array(
                ...
                "holder" => "div",
                "heading" => __("Find Suggestion Location ", ST_TEXTDOMAIN),
                "param_name" => "st_list_location",
                "description" =>""
            ),
            array(
                'type' => 'st_checkbox',
                'admin_label' => true,
                'heading' => __('Select Search Tab To Display', ST_TEXTDOMAIN),
                'param_name' => 'tabs_search',
                'description' => '',
                'stype' => 'get_option',
                'sparam' => 'search_tabs',
    ...
    vc_map( array(
        ...
        "params" => array(
            ...
            array(
                'type' => 'st_checkbox',
                'admin_label' => true,
                'heading' => __('Select Tabs Search To Display', ST_TEXTDOMAIN),
                'param_name' => 'tabs_search',
                'stype' => 'get_option',
                'sparam' => 'search_tabs',
                'std' => 'all'
