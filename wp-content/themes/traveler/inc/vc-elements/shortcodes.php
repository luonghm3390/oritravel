    ...
    function st_vc_alert($attr,$content=false)
    {
       $data = shortcode_atts(
        ...
        $txt ='<div class="alert '.$st_type.'">
                ...
                </div><a href="'.$st_link.'" class="btn '.$st_type.' '.$st_size.'">'.$st_title.'</a>';
        return $txt;
    }
    st_reg_shortcode('st_about_us','st_vc_alert');
...
if(!function_exists('st_vc_all_post_type_content_search')){
    function st_vc_all_post_type_content_search($attr,$content=false)
    {
        ...
        if($data_post_type == 'all'){
            $data_post_type = array('st_rental' , 'st_cars' , 'st_tours' , 'st_activity');
        }else{
...
if(!function_exists('st_vc_search')){
    function st_vc_search($attr,$content=false)
    {
        ...
        $txt = st()->load_template('vc-elements/st-search/search','form',array('data'=>$data, 'ids'=>$ids));
        return $txt;
    }
