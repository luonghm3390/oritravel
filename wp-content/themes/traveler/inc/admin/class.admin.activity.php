            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Set activity as featured', ST_TEXTDOMAIN ),
                            'id'    => 'is_featured',
                            'type'  => 'on-off',
                            'desc'  => __( 'Will show this activity with feature label.', ST_TEXTDOMAIN ),
                            'std'   => 'off'
                        ],
                        [
                        ...
                        [
                            'label'   => __( 'Activity types', ST_TEXTDOMAIN ),
                            'id'      => 'type_activity',
                            'type'    => 'select',
                            'choices' => [
                                [
                        ...
                        [
                            'label'        => __( 'Booking time period prior to arrival', ST_TEXTDOMAIN ),
                        ...
                        [
                            'label' => __( 'Activity duration', ST_TEXTDOMAIN ),
                            'id'    => 'activity-time',
                            'type'  => 'text',
                        ],
                        [
                        ...
                        [
                            'label'     => __( 'Affiliate activity link', ST_TEXTDOMAIN ),
                        ...
                        [
                            'label'     => __( 'Deposit total', ST_TEXTDOMAIN ),
