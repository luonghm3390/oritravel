            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Set car as featured', ST_TEXTDOMAIN ),
                            'id'    => 'is_featured',
                            'type'  => 'on-off',
                            'desc'  => __( 'Will show this car with feature label', ST_TEXTDOMAIN ),
                            'std'   => 'off'
                        ],
                        [
                        ...
                        [
                            'label' => __( 'About This Car', ST_TEXTDOMAIN ),
                            'id'    => 'cars_about',
                            'type'  => 'textarea',
                        ],
                        [
                        ...
                        [
                            ...
                            'id'    => 'cars_email',
                            'type'  => 'text',
                            'desc'  => __( 'This address will received email when have new booking', ST_TEXTDOMAIN ),
                        ],
                        [
                        ...
                        [
                            'label' => __( 'Car Price', ST_TEXTDOMAIN ),
                            'id'    => 'cars_price',
                            'type'  => 'text',
                        ...
                        [
                            'label'        => __( 'Minimum rental date', ST_TEXTDOMAIN ),
                        ...
                        ( st()->get_option( 'cars_price_unit', 'day' ) == 'day' ) ?
                            [
                                'label'        => __( 'Minimum days to hire', ST_TEXTDOMAIN ),
                            ...
                            : [
                            'label'        => __( 'Minimum hours to hire', ST_TEXTDOMAIN ),
                        ...
                        [
                            'label'     => __( 'Affiliate car link', ST_TEXTDOMAIN ),
