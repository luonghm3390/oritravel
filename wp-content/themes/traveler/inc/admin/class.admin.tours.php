            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Set tour as featured', ST_TEXTDOMAIN ),
                            'id'    => 'is_featured',
                            'type'  => 'on-off',
                            'desc'  => __( 'Will show this tour with feature label.', ST_TEXTDOMAIN ),
                            'std'   => 'off'
                        ],
                        [
                        ...
                        [
                            ...
                            'id'    => 'video',
                            'type'  => 'text',
                            'desc'  => __( 'Supported youtube/vimeo url.', ST_TEXTDOMAIN )
                        ],
                        ...
                        [
                            ...
                            'desc'    => __( 'Use service detail', ST_TEXTDOMAIN ),
                        ],
	                    ...
	                    [
		                    'label'   => __( 'Price types', ST_TEXTDOMAIN ),
		                    'id'      => 'tour_price_by',
		                    'type'    => 'select',
		                    'choices' => [
			                    [
                        ...
                        [
                            'label'    => __( 'Extra service price', ST_TEXTDOMAIN ),
                            'id'       => 'extra_price',
                            'type'     => 'list-item',
                            'settings' => [
                                [
                                ...
                                [
                                    ...
                                    'type'  => 'text',
                                    'std'   => '',
                                    'label' => __( 'Price (per 1 item)', ST_TEXTDOMAIN ),
                                ],
                                [
                                    'id'    => 'extra_required',
                                    'type'  => 'on-off',
                        ...
                        [
                            'label' => __( 'Discount total', ST_TEXTDOMAIN ),
                            'id'    => 'discount',
                            'type'  => 'text',
                            'desc'  => __( 'Total discount of this tour', ST_TEXTDOMAIN ),
                            'std'   => 0
                        ],
                        [
                            'label'   => __( 'Type of discount', ST_TEXTDOMAIN ),
                            'id'      => 'discount_type',
                            'desc'  => __( 'Apply for Discount total', ST_TEXTDOMAIN ),
                            'type'    => 'select',
                            'choices' => [
                                [
                                    'label' => __( 'Percent', ST_TEXTDOMAIN ),
                        ...
                        [
                            ...
                            'label'   => __( "Deposit payment", ST_TEXTDOMAIN ),
                            'type'    => 'select',
                            'choices' => [
                                [
                                    'value' => '',
                        ...
                        [
                            'label'   => __( 'Tour types', ST_TEXTDOMAIN ),
                            'id'      => 'type_tour',
                            'type'    => 'select',
                            'desc'    => __( 'If you selected the \'Specific Date\' tour, you need to set price in \'Availability\' tab (required)', ST_TEXTDOMAIN ),
                            'choices' => [
                                [
                                    'value' => 'daily_tour',
                        ...
                        [
                            'label'     => __( 'Tour Duration', ST_TEXTDOMAIN ),
                            'id'        => 'duration_day',
                            'type'      => 'text',
                            'desc'      => __( 'Example: <em>3 days 2 nights</em>', ST_TEXTDOMAIN ),
                            'std'       => '',
                        ...
                        [
                            ...
                            'type'  => 'on-off',
                            'std'   => "off",
                            'desc'  => __( 'Booking in 3rd affiliate system.', ST_TEXTDOMAIN )
                        ],
                        [
                            'label'     => __( 'Affiliate tour link ', ST_TEXTDOMAIN ),
                        ...
                        [
                            'label' => __( 'Min of people in tour', ST_TEXTDOMAIN ),
                            'id'    => 'min_people',
                            'type'  => 'text',
                            'std'   => '1',
                        ],
                         ...
                         **/
                        [
                            'label' => __( 'Max of people in tour', ST_TEXTDOMAIN ),
                            'id'    => 'max_people',
                            'type'  => 'text',
                            'desc'  => __( 'Leave empty or enter \'0\' for unlimited', ST_TEXTDOMAIN ),
                            'std'   => '0',
                        ],
                        [
                            'id'       => 'tours_program',
                            'label'    => __( "Tour itenirary", ST_TEXTDOMAIN ),
                            'type'     => 'list-item',
                            'settings' => [
                                [
                                    'id'    => 'desc',
                        ...
                        [
                            'label'        => __( 'Percent of total price for the canceling', ST_TEXTDOMAIN ),
