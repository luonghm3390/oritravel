            ...
            function _add_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Set rental as featured', ST_TEXTDOMAIN ),
                            'id'    => 'is_featured',
                            'type'  => 'on-off',
                            'desc'  => __( 'Will show this rental with feature label', ST_TEXTDOMAIN ),
                            'std'   => 'off'
                        ],
                        [
                            'id'    => 'rental_number',
                            'label' => __( 'Number of rental available for booking', ST_TEXTDOMAIN ),
                            'type'  => 'text',
                            'std'   => '1'
                        ],
                        [
                        ...
                        [
                            ...
                            'desc'    => __( 'Use contact info in service detail', ST_TEXTDOMAIN ),
                        ],
                        [
                            'label' => __( 'Agent email', ST_TEXTDOMAIN ),
                            'id'    => 'agent_email',
                            'type'  => 'text',
                            'desc'  => __( 'This email will receive emails notifying new booking', ST_TEXTDOMAIN ),
                        ],
                        [
                        ...
                        [
                            ...
                            'std'     => 'percent',
                            'desc'    => __( 'This only use for discount by number of days.', ST_TEXTDOMAIN )
                        ],
                        [
                        ...
                        [
                            ...
                            'id'    => 'discount_rate',
                            'type'  => 'text',
                            'desc'  => __( 'Discount rate by percent (%)', ST_TEXTDOMAIN )
                        ]
                        , [
                        ...
                        [
                            'label'        => __( 'Minimum day booking', ST_TEXTDOMAIN ),
                        ...
                        [
                            'label'     => __( 'Affiliate rental link', ST_TEXTDOMAIN ),
