...
if (!class_exists('STUser_f')) {
    class STUser_f extends TravelerObject
    {
        ...
        */
        ...
        static function get_history_bookings($type = "st_tour", $offset, $limit, $author = false)
        {
            global $wpdb;
            $querystr = "
        ...
        static function get_history_bookings_send_mail($type = "st_tour", $offset, $limit, $author = false)
        {
            global $wpdb;
            $where = "";
        ...
        static function _get_list_item_service_available($post_type = "st_rental", $user_id, $page = 1)
        {
