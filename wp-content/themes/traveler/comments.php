...
<div id="comments" class="comments-area">
    <!--<h2><?php esc_html_e('Comment','traveler')?></h2> -->
    <?php if ( have_comments() ) : ?>
        <h3 class="comments-title">
            <?php
            printf( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', ST_TEXTDOMAIN ),
