...
<div class="bg-holder full text-center text-white style1">
    ...
    <div class="bg-front full-center">
        <div class="owl-cap">
            <div class="header-location col-md-6">
                <h4 class="owl-cap-title fittext">
                    <?php the_title() ?>
                </h4>
                <p class="booking-item-description" style="width: 50%;left: 50%;display: inline-block;">
                        <?php echo st_get_the_excerpt_max_charlength(500); ?>
                </p>
                <?php
                ...
                ?>
                <a class="btn btn-white btn-ghost btn-location-learn-more" href="<?php echo esc_url($link) ?>">
                    <i class="fa fa-long-arrow-right"></i>
                    <?php esc_html_e('LEARN MORE','traveler') ?>
                </a>
            </div>

            <?php if($st_weather == 'yes' and $c){ ?>
            <div class="owl-cap-weather col-md-6">
                <span>
                ...
                <div class="owl-cap-price <?php echo esc_html($st_type) ?>">
                    ...
                    echo '<small>'.STLanguage::st_get_language("from", ST_TEXTDOMAIN).'</small><h5>'.TravelHelper::format_money($min_price).'</h5>';
                    ?>
                </div>
            </div>
            <?php } ?>
