...
<div id='top_toolbar' class="<?php echo ($hidden_topbar_in_mobile=='on'?'hidden_topbar_in_mobile':'')?>" style= 'background-color: <?php echo st()->get_option('topbar_bgr', "#333"); ?> ' >
    <div class='container'>
        <div class="row">
            <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 text-left left_topbar'>                
                    <!-- <?php 
            ...
            <div class='col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right right_topbar top-user-area'>                
                    <!-- <?php 
